...
{
    public partial class AudioInputVolumeSliderControl : PluginUserControl
    {
        ...
        public AudioInputVolumeSliderControl(AudioSwitcherPlugin plugin)
        {
            this.plugin = plugin;
            InitializeComponent();
            Loaded += AudioInputVolumeSliderControl_Loaded;
        }

        private void AudioInputVolumeSliderControl_Loaded(object sender, RoutedEventArgs e)
        {
            Refresh();
        }
        ...
        private void SetSliderValue(int value, bool muted)
        {
            ...
            try
            {
                ...
                VolumeLabel.Text = muted ? plugin.Loc("LOCAS_InputMuted") : $"{(int)Math.Round(VolumeSlider.Value)}%";
            }
            finally
            {
                isRefreshing = false;
        ...
        private void VolumeSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            ...
            plugin.Theme.CurrentInputVolumePercent = percent;
        }
