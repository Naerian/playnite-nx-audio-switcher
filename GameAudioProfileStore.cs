...
namespace PlayniteAudioSwitcher
{
    public sealed class GameAudioProfileStore
    {
        ...
        public void SetAudioProcessName(Game game, string processName)
        {
            if (game == null)
            {
                return;
            ...
            lock (syncRoot)
            {
                ...
                profile.AudioProcessName = string.IsNullOrWhiteSpace(processName)
                    ? null
                    : processName.Trim();
        ...
        private static bool IsEmpty(GameAudioProfile profile)
        {
            return profile == null ||
                ...
                string.IsNullOrWhiteSpace(profile.AudioProcessName) &&
        ...
        private static GameAudioProfile CloneProfile(GameAudioProfile profile)
        {
            ...
            return new GameAudioProfile
            {
                ...
                AudioProcessName = profile.AudioProcessName
            };
        }
    }
}
